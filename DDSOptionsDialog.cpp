...
void DDSOptionsDialog::do_layout()
{
	...
	topSizer->Add(useDXTC, 0, wxALL, 10);
	topSizer->Add(generateMipmaps, 0, wxLEFT|wxRIGHT|wxBOTTOM, 10);
	mipmapSizer->Add(repeatingTexture, 0, wxRIGHT|wxLEFT|wxBOTTOM|wxEXPAND, 10);
	mipmapSizer->Add(mipmapFilterSizer, 0, wxRIGHT|wxLEFT|wxBOTTOM | wxEXPAND, 10);
	mipmapIndenter->Add(20, 20, 0, 0, 1);
	mipmapBox->Add(colorFillBackground, 0, wxALL, 10);
	colorFillIndenter->Add(20, 20, 0, 0, 0);
	colorFillBox->Add(reconstructColors, 0, wxLEFT|wxRIGHT|wxBOTTOM, 10);
	chooseBackgroundIndenter->Add(20, 20, 0, 0, 0);
	chooseBackgroundIndenter->Add(chooseBackground, 0, wxLEFT|wxRIGHT|wxBOTTOM, 10);
